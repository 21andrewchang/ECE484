...
def line_fit(binary_warped):
	...
	for window in range(nwindows):
		...
		##TO DO
		win_y_low = height - window * window_height
		win_y_high = height - (window + 1) * window_height
		left_win_left_x_boundary = leftx_current - margin
		left_win_right_x_boundary = leftx_current + margin
		right_win_left_x_boundary = rightx_current - margin
		right_win_right_x_boundary = rightx_current + margin
		
		####
		# Draw the windows on the visualization image using cv2.rectangle()
		##TO DO
		cv2.rectangle(out_img, (left_win_left_x_boundary, win_y_low), (left_win_right_x_boundary, win_y_high), (0,255,0), 2)
		cv2.rectangle(out_img, (right_win_left_x_boundary, win_y_low), (right_win_right_x_boundary, win_y_high), (0,255,0), 2)


		####
		# Identify the nonzero pixels in x and y within the window
		##TO DO
		in_left_lane = (nonzeroy >= win_y_low) & (nonzeroy <= win_y_low)
